---
name: dnd5e-leveling-up
description: Walk a player through gaining a D&D 5e level — HP, proficiency, features, spells, ASIs/feats. Updates character JSON and session log. Use when a PC in a dnd5e campaign hits an XP threshold (or whenever milestone leveling triggers).
---
