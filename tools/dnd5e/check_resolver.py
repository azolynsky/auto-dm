#!/usr/bin/env python3
"""
Resolve a D&D 5e skill check or saving throw against a DC, using a real dice
roll. 5e-specific (ability-mod formula, proficiency/expertise math, the 18
skills) — other rule systems get their own resolver under tools/<system>/.

Usage:
    python tools/dnd5e/check_resolver.py --char <save>/characters/<id>.json \\
        --skill stealth --dc 15
    python tools/dnd5e/check_resolver.py --char <save>/characters/<id>.json \\
