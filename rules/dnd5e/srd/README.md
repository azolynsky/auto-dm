...
```bash
grep -ril "grappl" rules/dnd5e/srd/06_Gameplay/
cat "rules/dnd5e/srd/07_Spells/Spells_Each/Counterspell.md"
grep -il "owlbear" rules/dnd5e/srd/10_Monsters/*.md
grep -n "Exhaustion" rules/dnd5e/srd/08_Gamemastering/Conditions.md
```
