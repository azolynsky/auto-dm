---
name: dnd5e-combat-encounter
description: Run a D&D 5e combat encounter from initiative through end-of-fight. Use whenever combat starts in a dnd5e campaign, on every turn during combat, and to wrap up after the last enemy falls or surrenders.
---
...
### Saving throw
```bash
python tools/dnd5e/check_resolver.py --char "<active save>/characters/<id>.json" --save dex --dc 15
```
...
5. **Award XP** per `dnd5e-encounter-building` skill.
