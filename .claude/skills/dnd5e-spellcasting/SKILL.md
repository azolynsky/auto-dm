---
name: dnd5e-spellcasting
description: Resolve a D&D 5e spell cast — slot consumption, attack/save mechanics, concentration, counterspell timing, components. Use whenever a PC or NPC casts in a dnd5e campaign.
---
...
5. **Resolution:**
   ...
   - **Saving throw**: target rolls vs spell save DC.
     ```bash
     python tools/dnd5e/check_resolver.py --char "<active save>/characters/<id>.json" --save wis --dc 14
     ```
