...
- **"like a..." similes: minimum use, and they must survive being pictured literally.**
  ...
  The same rule catches **action-vs-action similes** — "he [does X] like a [person] [doing Y]." Comparing a thing to a thing can earn its keep; comparing an action to another hypothetical action almost never does, and the pattern reads as a reflex once you see it twice. (Called out at the table, session 9 — five examples in two sessions: "nods once, like a merchant closing a ledger," "says, like a man finding rain on market day," "goes through the drow's pockets like a man reading a trail," "looking from his brother to the strangers like a man rechecking arithmetic," "clings like a burr made of wet leather." Recurred session 13 despite this entry — three more: "answers the easy questions like a man reading a shopping list," "closes his eyes like a man watching his luck sink to the bottom of the harbor," "sit down on the deck like schoolboys." The reflex survives knowing the rule; the pre-delivery pass must test EVERY "like a" against this pattern specifically.)
...
- **Watch the "like a [noun] [verb]-ing" movement simile.** Comparing a character's movement to a thing performing an action ("slips under the cloth like a whisper going under a door," "goes up the chimney like a spark returning to the sky") is the action-vs-action pattern in a prettier coat. Flagged by the wrap pass, session 15 — it showed up twice in one infiltration sequence. One per session at most, and only when the image carries real sensory content; when in doubt, describe the movement itself.
